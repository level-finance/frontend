<template>
  <div>
    <div class="subsection">
      <h1>Level Finance OU Privacy&nbsp;Policy</h1>
      <p><em>Last Updated: November 16, 2021</em></p>
      <p>
        <em class="font-medium">
          This Privacy Policy explains how Level Finance OU and its subsidiaries
          and affiliates (“Level Finance,” “we,” “our,” or “us”) collects, uses,
          and discloses information about you. This Privacy Policy applies when
          you use our website, Level Protocol user-interface or application and
    ...
    <div class="subsection">
      ...
      <p>
        The Level Finance UI is not directed to children under the age of 16. If
        ...
        <a class="link" href="mailto:privacypolicy@lvl.finance"
          >privacypolicy@lvl.finance</a
      ...
      <p>
        ...
        accessible to Level Finance and its vendor(s).
      </p>
    </div>
    <div class="subsection">
      ...
      <ul>
        <li>Ensure proper functioning of Level Finance and the UI;</li>
        <li>
        ...
        <li>
          ...
          rights and property of Level Finance and others;
        </li>
    ...
    <div class="subsection">
      ...
      <p>
        ...
        the normal course of Level Finance business. However, when Level Finance
      ...
      <ul>
        ...
        <li>
          ...
          the rights, property, and safety of Level Finance, the Level
        ...
        <li>
          Personal information may be shared between and among Level Finance and
    ...
    <div class="subsection">
      ...
      <p>
        ...
        customized campaigns on the UI or third-party UIs. Level Finance may
    ...
    <div class="subsection">
      ...
      <p>
        Level Finance is headquartered in Estonia. Therefore, we and our service
    ...
    <div class="subsection">
      ...
      <h3>Cookies</h3>
      <p>
        Level Finance does not typically use any cookies. It reserves the
    ...
    <div class="subsection">
      ...
      <p>
        Level Finance does not “sell” personal information to advertise our
      ...
      <p>
        ...
        requests by emailing us at privacypolicy@lvl.finance. If we receive your
        request from an authorized agent, we may ask for evidence that you have
        provided such agent with a power of attorney or that the agent otherwise
        has valid written authority to submit requests to exercise rights on
        your behalf. If you are an authorized agent seeking to make a request,
        please contact us.
      </p>
      ...
      <p>
        Level Finance does not share such information with third parties for
    ...
    <div class="subsection">
      ...
      <p>
        Level Finance does not typically process user personal data. If Level
        Finance processes data, such as a wallet address and certain IP
        addresses, it will do so in reliance on the following lawful bases:
      </p>
      <ul>
        <li>
      ...
      <p>
        ...
        certain processing. Level Finance does not typically hold such personal
        data.
      </p>
    </div>
    <div>
